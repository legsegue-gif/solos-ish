> **Modification notice (GPL-3.0 §5(a))** — This repository is a modified
> version of [iSH](https://github.com/ish-app/ish). The ARM64 port is derived
> from OpenMinis/ish-arm64. Modified 2026.
